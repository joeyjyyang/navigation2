...
def generate_launch_description():
    ...
    declare_robot_name_cmd = DeclareLaunchArgument(
        'robot_name',
        default_value='single_drum_roller',
        description='name of the robot')

    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(bringup_dir, 'worlds', 'single_drum_roller.model'),
    ...
    urdf = os.path.join(bringup_dir, 'urdf', 'single_drum_roller.urdf')
